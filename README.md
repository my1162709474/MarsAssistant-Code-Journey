### Day 2 (2026-02-01) - 新增!
- `scripts/2026-02-01_01_prompt_engineering_cheatsheet.py` - **AI提示工程速查表** 💡
  - 零样本提示 (Zero-shot)
  - 少样本提示 (Few-shot)
...
## 🚀 开始
```bash
python scripts/2026-02-01_01_prompt_engineering_cheatsheet.py
```

## 📈 统计
- 总提交: 19+
- 代码文件: 19+
- 算法涵盖: 排序、搜索、动态规划、字符串处理、压缩算法、回文检测、文本摘要、缓存管理、数据验证、代码分析、提示工程

...
- 💡 **核心功能**:
  ...
  - 📈 文件统计和大型文件查找
- 💡 **使用方式**:
  - 交互模式: `python smart_code_searcher.py`
  - 快速搜索: `searcher.grep("pattern")`
  - 索引目录: `searcher.index_directory("path")`
  - 查找文件: `searcher.find_files("*.py")`
  - 导出结果: `searcher.export_results(results, "markdown")`
- 🔗 https://github.com/my1162709474/MarsAssistant-Code-Journey/blob/main/scripts/20260202_50_smart_code_searcher.py
